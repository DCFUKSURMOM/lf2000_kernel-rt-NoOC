...
bcmsdh_intr_enable(void *sdh)
{
	...
	// davidychang
	//printf("bcmsdh_intr_enable: Exit status=%d\n", status);
...
bcmsdh_intr_disable(void *sdh)
{
	...
	// davidychang
	//printf("bcmsdh_intr_disable: Exit status=%d\n", status);
...
bcmsdh_intr_reg(void *sdh, bcmsdh_cb_fn_t fn, void *argh)
{
	...
	// davidychang
	printf("bcmsdh_intr_reg: sdioh_interrupt_register ...\n");
