...
#define EP_FIFO_SIZE		512
#define EP_FIFO_SIZE2		1024
#define S3C_MAX_ENDPOINTS	8	/* jhkim : change 16 */
#define DED_TX_FIFO		0	/* Dedicated NPTx fifo for LF2000? */
#endif
...
#define ep_index(EP) 		((EP)->bEndpointAddress&0x7)
